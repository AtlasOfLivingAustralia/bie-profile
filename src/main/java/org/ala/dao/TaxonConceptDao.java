...
public interface TaxonConceptDao {
	...
	boolean addHabitat(String guid, Habitat habitat) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean syncTriplesReturnSuccess(org.ala.model.Document document, List<Triple> triples, Map<String, String> dublinCore, boolean statsOnly) throws Exception;

	/**
	 * Synchronises these triples to a taxon concept in hbase.
	 *
	 * @return Guid (lsid) if we where able to add these properties to an existing
	 ...
	 * @throws Exception
	 */	
	public String syncTriples(org.ala.model.Document document, List<Triple> triples, Map<String, String> dublinCore, boolean statsOnly) throws Exception;
